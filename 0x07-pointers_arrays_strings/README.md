...
#### General
    ...
    - A README.md file, at the root of the folder of the project is     - Your code should use the Betty style. It will be checked using betty-style.pl and betty-doc.pl
